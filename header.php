...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Rana Junaid Hashim" />
        <meta name="author" content="Rana Junaid Hashim" />
        <title>My Blog</title>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light" id="mainNav">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="index.php">Research Book</a>
